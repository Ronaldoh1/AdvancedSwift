...
//say that you want to cut down on the code for each lazy property. you could create a separate method and make it private. like below. 
...
class Singer {
    ...
    lazy var reversedName: String = self.reverseName1()

    private func reverseName1() -> String {
        return String(name.uppercased().characters.reversed())
    }
}